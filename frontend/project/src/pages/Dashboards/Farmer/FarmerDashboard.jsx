...
export default function FarmerDashboard() {
  ...
  const goToPrediction = (veg, market) => {
    navigate(
      `/dashboard/predictions?veg=${encodeURIComponent(veg)}&market=${encodeURIComponent(market)}`
    );
  };
    ...
    <div className="dashboard-container farmer-dashboard">
      ...
      <div className="farmer-table-card liquid-glass">
        ...
        {loading ? (
          ...
          <p className="farmer-empty">No stock submitted yet</p>
        ) : (
            ...
            <tbody>
              {stocks.map((s) => (
                <tr
                  ...
                  onClick={() => goToPrediction(s.vegetable, s.market)}
